...
export const content: ContentConfig = {
  ...
  colors: {
    primary: '#3EDDF3',      // Cor principal (Botões, destaques, ícones)
    primaryDark: '#ffffffff',  // Cor principal escura (Hover)
    primaryHighlight: '#3EDDF3', // Cor para textos destacados e ícones soltos (Pode ser igual a primary ou ajustada)
    ...
    plans: [
      {
        ...
        price: '89,99',
        period: '/mês',
        features: ['Musculação + Aulas (Zumba, Jump, Cross, Pilates e Muay Thai)', 'Menor preço garantido', '12x no cartão', 'Fidelidade 12 meses'],
        highlighted: true,
